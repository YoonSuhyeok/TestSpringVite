...
// ../../node_modules/.pnpm/tsup@8.1.0_@swc+core@1.5.27_postcss@8.4.38_typescript@5.4.5/node_modules/tsup/assets/cjs_shims.js
...
__export(src_exports, {
  ...
  createRollupInputConfig: () => createRollupInputConfig,
  default: () => src_default,
  java: () => java,
...
// ../../node_modules/.pnpm/glob@10.4.1/node_modules/glob/dist/esm/index.js
init_cjs_shims();

// ../../node_modules/.pnpm/minimatch@9.0.4/node_modules/minimatch/dist/esm/index.js
init_cjs_shims();
var import_brace_expansion = __toESM(require_brace_expansion(), 1);

// ../../node_modules/.pnpm/minimatch@9.0.4/node_modules/minimatch/dist/esm/assert-valid-pattern.js
init_cjs_shims();
...
// ../../node_modules/.pnpm/minimatch@9.0.4/node_modules/minimatch/dist/esm/ast.js
init_cjs_shims();

// ../../node_modules/.pnpm/minimatch@9.0.4/node_modules/minimatch/dist/esm/brace-expressions.js
init_cjs_shims();
var posixClasses = {
...
// ../../node_modules/.pnpm/minimatch@9.0.4/node_modules/minimatch/dist/esm/unescape.js
init_cjs_shims();
...
// ../../node_modules/.pnpm/minimatch@9.0.4/node_modules/minimatch/dist/esm/escape.js
init_cjs_shims();
...
// ../../node_modules/.pnpm/glob@10.4.1/node_modules/glob/dist/esm/glob.js
init_cjs_shims();
...
// ../../node_modules/.pnpm/glob@10.4.1/node_modules/glob/dist/esm/pattern.js
init_cjs_shims();
...
// ../../node_modules/.pnpm/glob@10.4.1/node_modules/glob/dist/esm/walker.js
init_cjs_shims();

// ../../node_modules/.pnpm/glob@10.4.1/node_modules/glob/dist/esm/ignore.js
init_cjs_shims();
...
// ../../node_modules/.pnpm/glob@10.4.1/node_modules/glob/dist/esm/processor.js
init_cjs_shims();
...
// ../../node_modules/.pnpm/glob@10.4.1/node_modules/glob/dist/esm/has-magic.js
init_cjs_shims();
...
// src/utils.ts
var PLUGIN_NAME = "vite-plugin-java";
var filter2 = import_node_process.default.env.VITE_DEBUG_FILTER;
function createDebugger(namespace) {
  const log = (0, import_debug.default)(namespace);
  const enabled = log.enabled;
  if (enabled) {
    return (...args) => {
      if (!filter2 || args.some((a) => a?.includes?.(filter2))) {
        log(...args);
      }
    };
  }
}
function createRollupInputConfig(pattern = "src/**/main.ts", baseDir = "src", options = {}) {
  ...
  return Object.fromEntries(
    globSync(pattern, globOptions).map((file) => {
      ...
      const absolutePath = import_node_path2.default.resolve(cwd, filepath);
      return [
        import_node_path2.default.relative(baseDir, filepath.slice(0, filepath.length - import_node_path2.default.extname(filepath).length)),
        absolutePath
      ];
    })
  );
...
function dirname() {
  return (0, import_node_url3.fileURLToPath)(new URL(".", importMetaUrl));
}
function isMavenProject(projectRoot = "") {
  return import_node_fs.default.existsSync(import_node_path2.default.join(projectRoot || import_node_process.default.cwd(), "pom.xml"));
}
function isGradleProject(projectRoot = "") {
  return import_node_fs.default.existsSync(import_node_path2.default.join(projectRoot || import_node_process.default.cwd(), "build.gradle"));
}
function isKotlinDSLProject(projectRoot = "") {
  return import_node_fs.default.existsSync(import_node_path2.default.join(projectRoot || import_node_process.default.cwd(), "build.gradle.kts"));
}
function readPropertiesFile(pattern, options) {
  const properties = /* @__PURE__ */ new Map();
  const _pattern = pattern || "**/*.properties";
  const _options = merge({}, options || {}, { cwd: import_node_process.default.cwd() });
  globSync(_pattern, _options).forEach((file) => {
    const _file = typeof file === "string" ? file : file.path;
    const content = import_node_fs.default.readFileSync(_file, "utf-8");
...
function javaVersion(projectRoot = ".") {
  try {
    let version;
    if (isMavenProject(projectRoot)) {
      const pom = import_node_fs.default.readFileSync(import_node_path2.default.join(projectRoot, "pom.xml")).toString();
      version = pom.match(/<java.version>(.*)<\/java.version>/)?.[1];
    }
    if (isGradleProject(projectRoot)) {
      const gradle = import_node_fs.default.readFileSync(import_node_path2.default.join(projectRoot, "build.gradle")).toString();
    ...
    if (isKotlinDSLProject(projectRoot)) {
      const gradleKts = import_node_fs.default.readFileSync(import_node_path2.default.join(projectRoot, "build.gradle.kts")).toString();
...
function pluginVersion() {
  try {
    return JSON.parse(import_node_fs.default.readFileSync(import_node_path2.default.join(dirname(), "../package.json")).toString())?.version;
  } catch {
    return "";
  }
}
...
// src/vite-plugin-java.ts
var debug2 = createDebugger(`${PLUGIN_NAME}`);
var exitHandlersBound = false;
function java(config) {
  debug2?.(`${PLUGIN_NAME} plugin initialized.`);
  debug2?.("config, %O", config);
  const pluginConfig = resolvePluginConfig(config);
  debug2?.("resolved config, %O", pluginConfig);
  return resolveJavaPlugin(pluginConfig);
}
function resolveJavaPlugin(pluginConfig) {
  debug2?.("start resolving plugins.");
  ...
  const plugins = [
    {
      ...
      config: (config, { command, mode }) => {
        debug2?.("configuring plugin, command: %s, mode: %s", command, mode);
        userConfig = config;
        const env = (0, import_vite.loadEnv)(mode, config.envDir || import_node_process2.default.cwd(), "");
        const assetUrl = env.ASSET_URL ?? "/";
        const serverConfig = command === "serve" ? resolveEnvironmentServerConfig(env) : void 0;
        return {
      ...
      configResolved(config) {
        ...
        debug2?.("config resolved.");
      },
      transform(code) {
        if (resolvedConfig.command === "serve") {
          debug2?.("transforming code for serve.");
          code = code.replace(/__java_vite_placeholder__/g, viteDevServerUrl);
          return pluginConfig.transformOnServe(code, viteDevServerUrl);
        }
      },
      configureServer(server) {
        const envDir = resolvedConfig.envDir || import_node_process2.default.cwd();
        const properties = readPropertiesFile();
        const appUrl = (0, import_vite.loadEnv)(resolvedConfig.mode, envDir, "APP_URL").APP_URL ?? properties.get("app.url") ?? "undefined";
        server.httpServer?.once("listening", () => {
          debug2?.("server listening.");
  ...
  ${import_picocolors.default.red(`${import_picocolors.default.bold("JAVA")} ${javaVersion(pluginConfig.javaProjectBase)}`)}  ${import_picocolors.default.dim("plugin")} ${import_picocolors.default.bold(`v${pluginVersion()}`)}`);
              server.config.logger.info("");
              if (appUrl !== "undefined") {
        ...
        if (!exitHandlersBound) {
          import_node_process2.default.on("SIGINT", () => import_node_process2.default.exit());
          import_node_process2.default.on("SIGTERM", () => import_node_process2.default.exit());
          import_node_process2.default.on("SIGHUP", () => import_node_process2.default.exit());
        ...
        return () => server.middlewares.use((req, res, next) => {
          if (req.url === "/index.html") {
            res.statusCode = 404;
            res.end(
              import_node_fs2.default.readFileSync(import_node_path3.default.join(dirname(), "dev-server-index.html")).toString().replace(/\{\{ APP_URL \}\}/g, appUrl)
            );
          }
          next();
        });
...
function resolveEnvironmentServerConfig(env) {
  ...
  if (!import_node_fs2.default.existsSync(env.VITE_DEV_SERVER_KEY) || !import_node_fs2.default.existsSync(env.VITE_DEV_SERVER_CERT)) {
  ...
  return {
    ...
    host,
    https: {
      key: import_node_fs2.default.readFileSync(env.VITE_DEV_SERVER_KEY),
      cert: import_node_fs2.default.readFileSync(env.VITE_DEV_SERVER_CERT)
    }
  };
}
